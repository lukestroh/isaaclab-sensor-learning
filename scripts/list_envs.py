...
All the environments are registered in the `isaaclab_sensor_learning` extension. They start
...
def main():
    """Print all environments registered in `isaaclab_sensor_learning` extension."""
